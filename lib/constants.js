...
export const ALPHA_EMA = 0.20;            // Holt level smoothing (validated α; effective window ≈ 5 turns)
export const BETA_TREND = 0.05;           // Holt trend smoothing; dampens directional momentum
