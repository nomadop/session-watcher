...
// metrics / baseline / history read L, EXCEPT the carve-outs that read the row's raw fields on
// purpose: the kFit tail, the segmentation total, the dashboard raw display, and the history L line,
// which `computeHistoryPoint` plots as total stock so a parallel-tool plateau or a cacheCreation-less
// miss does not flatten the curve. Null-safe: a nullish record yields 0 (never throws), though
// internal callers always pass a real record.
