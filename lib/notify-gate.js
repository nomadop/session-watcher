...
const MSG = 'Session Watcher: bill-regret is above the amber threshold and holding. Consider running /sw-handoff then /clear at the next natural boundary to preserve context while resetting cost.';
