...
// Canonical pp_frac helper (spec §3.3). Single implementation — NEVER inline (u-1)^2/(2u)
// at a call site. Used by segment archival + prepare_handoff snapshot. Mirrors the ppFrac
// term inside computeBr; returns a fraction (0.25 = the pp value where br = mf*0.25).
